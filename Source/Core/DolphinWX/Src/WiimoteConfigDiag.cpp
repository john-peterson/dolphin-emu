...
WiimoteConfigDiag::WiimoteConfigDiag(CFrame* parent, InputPlugin& plugin, const wxString& title)
	: wxDialog(NULL, -1, title, wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE | wxDIALOG_NO_PARENT)
	, m_parent(parent)
	, m_plugin(plugin)
{
