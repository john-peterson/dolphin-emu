...
#define SIMPLE_LOG(t, v, ...) { \
	if (v <= MAX_LOGLEVEL) \
		GenericLog(v, t, 0, 0, __VA_ARGS__); \
	}
#endif
...
#define ERROR_LOG_S(t,...) do { SIMPLE_LOG(LogTypes::t, LogTypes::LERROR, __VA_ARGS__) } while (0)
#define WARN_LOG_S(t,...) do { SIMPLE_LOG(LogTypes::t, LogTypes::LWARNING, __VA_ARGS__) } while (0)
#define NOTICE_LOG_S(t,...) do { SIMPLE_LOG(LogTypes::t, LogTypes::LNOTICE, __VA_ARGS__) } while (0)
#define INFO_LOG_S(t,...) do { SIMPLE_LOG(LogTypes::t, LogTypes::LINFO, __VA_ARGS__) } while (0)
#define DEBUG_LOG_S(t,...) do { SIMPLE_LOG(LogTypes::t, LogTypes::LDEBUG, __VA_ARGS__) } while (0)
